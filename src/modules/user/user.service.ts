...
const createUser = async(payload: Record<string, unknown>) => {
    ...
    const result = await pool.query(`INSERT INTO users(name, email, password, age, phone, address) VALUES($1, $2, $3, $4, $5, $6) RETURNING *`, [name, email, hashedPass, age, phone, address]);
